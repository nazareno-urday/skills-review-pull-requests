...
1. Enter the following comment and click the **Submit review** button.
   ...
   <img width="300" alt="Submit review button" src="https://github.com/nazareno-urday/skills-review-pull-requests/blob/main/.github/images/submit-review-button.png?raw=true" />
