...
1. Click the **Add a suggestion** button to insert a modifiable copy of the line.
   ...
   <img width="300" alt="add-a-suggestion-button" src="https://github.com/nazareno-urday/skills-review-pull-requests/blob/main/.github/images/add-a-suggestion-button.png?raw=true" />
